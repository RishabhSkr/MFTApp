    ...
    def perform_file_operation(self):
        ...
        if self.gui_mode:
            ...
            if network_path and network_user and network_pass and network_drive:
                ...
                if not mapped:
                    messagebox.showerror("Error", "Failed to map network drive. Check credentials and network path.")
                    return False
                base_destination = f"{network_drive}:\\" + os.path.relpath(base_destination, start=network_path)
                unmapped = True
        else:
        ...
        try:
            ...
            for file_path in files_to_process:
                try:
                    ...
                    return False
            # Unmap network drive if it was mapped
